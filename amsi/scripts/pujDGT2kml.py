...
class pullh2kml_eval():
    ...
    def standardGT2kml(self):
        ...
        self.Fcsv_GNSS = csv.reader(open('/home/wenws/Downloads/jdResult20190112.csv','r'))  # read csv context to csv_reader variable
...
if __name__ == '__main__':
	...
	if( len(pullh2kml_eval_.lon_)>5):
            ...
            with open('/home/wenws/Downloads/jdResult.kml', 'w') as fp:
                fp.write(content)
